...
# Словарь форматов с однобуквенными ключами
AUDIO_FORMATS = {
    'w': {
        'display': 'WAV',
        'ext': '.wav',
        ...
        'lossless': True,
        'sample_formats': {
            's16': {'name_key': 'bit_depth_16', 'default': True},
            's24': {'name_key': 'bit_depth_24'},
            's32': {'name_key': 'bit_depth_32'},
            'flt': {'name_key': 'bit_depth_32float'},
            'dbl': {'name_key': 'bit_depth_64float'},
        }
    },
    'f': {
        'display': 'FLAC',
        ...
        'lossless': True,
        'compression_levels': {
            '0': {'level': 0, 'name_key': 'flac_compression_fastest'},
            '1': {'level': 1, 'name_key': 'flac_compression_fastest'},
            '2': {'level': 2, 'name_key': 'flac_compression_fastest'},
            '3': {'level': 3, 'name_key': 'flac_compression_fastest'},
            '4': {'level': 4, 'name_key': 'flac_compression_standard'},
            '5': {'level': 5, 'name_key': 'flac_compression_standard', 'default': True},
            '6': {'level': 6, 'name_key': 'flac_compression_best'},
            '7': {'level': 7, 'name_key': 'flac_compression_best'},
            '8': {'level': 8, 'name_key': 'flac_compression_best'},
        }
    },
    'm': {
        'display': 'MP3',
        ...
        'lossless': False,
        'bitrates': {
            '96k': {'bitrate': '96k', 'name_key': 'bitrate_low'},
            '128k': {'bitrate': '128k', 'name_key': 'bitrate_medium'},
            '160k': {'bitrate': '160k', 'name_key': 'bitrate_standard'},
            '192k': {'bitrate': '192k', 'name_key': 'bitrate_high', 'default': True},
            '256k': {'bitrate': '256k', 'name_key': 'bitrate_very_high'},
            '320k': {'bitrate': '320k', 'name_key': 'bitrate_max'},
        },
        'qualities': {
            '0': {'quality': 0, 'name_key': 'mp3_quality_best'},
            '1': {'quality': 1, 'name_key': 'mp3_quality_best'},
            '2': {'quality': 2, 'name_key': 'mp3_quality_best', 'default': True},
            '3': {'quality': 3, 'name_key': 'mp3_quality_best'},
            '4': {'quality': 4, 'name_key': 'mp3_quality_best'},
            '5': {'quality': 5, 'name_key': 'mp3_quality_worst'},
            '6': {'quality': 6, 'name_key': 'mp3_quality_worst'},
            '7': {'quality': 7, 'name_key': 'mp3_quality_worst'},
            '8': {'quality': 8, 'name_key': 'mp3_quality_worst'},
            '9': {'quality': 9, 'name_key': 'mp3_quality_worst'},
        }
    },
    'a': {
        'display': 'AAC',
        ...
        'bitrates': {
            ...
            '128k': {'bitrate': '128k', 'name_key': 'bitrate_medium'},
            '160k': {'bitrate': '160k', 'name_key': 'bitrate_standard'},
            '192k': {'bitrate': '192k', 'name_key': 'bitrate_high'},
            '256k': {'bitrate': '256k', 'name_key': 'bitrate_very_high', 'default': True},
            '320k': {'bitrate': '320k', 'name_key': 'bitrate_max'},
        }
    },
    'o': {
        ...
        'lossless': False,
        'bitrates': {
            '64k': {'bitrate': '64k', 'name_key': 'bitrate_low'},
            '96k': {'bitrate': '96k', 'name_key': 'bitrate_medium'},
            '128k': {'bitrate': '128k', 'name_key': 'bitrate_standard', 'default': True},
            '160k': {'bitrate': '160k', 'name_key': 'bitrate_high'},
            '192k': {'bitrate': '192k', 'name_key': 'bitrate_very_high'},
            '256k': {'bitrate': '256k', 'name_key': 'bitrate_max'},
        }
    },
    'g': {
        'display': 'OGG',
        ...
        'qualities': {
            ...
            '0': {'quality': 0, 'name_key': 'ogg_quality_worst'},
            '1': {'quality': 1, 'name_key': 'ogg_quality_worst'},
            '2': {'quality': 2, 'name_key': 'ogg_quality_worst'},
            '3': {'quality': 3, 'name_key': 'ogg_quality_worst', 'default': True},
            '4': {'quality': 4, 'name_key': 'ogg_quality_best'},
            '5': {'quality': 5, 'name_key': 'ogg_quality_best'},
            '6': {'quality': 6, 'name_key': 'ogg_quality_best'},
            '7': {'quality': 7, 'name_key': 'ogg_quality_best'},
            '8': {'quality': 8, 'name_key': 'ogg_quality_best'},
            '9': {'quality': 9, 'name_key': 'ogg_quality_best'},
            '10': {'quality': 10, 'name_key': 'ogg_quality_best'},
        }
    },
    '4': {
        'display': 'M4A',
...
# Для sample rate используем порядковые номера в меню, поэтому храним список ключей
SAMPLE_RATES = {
    '8000': {'rate': 8000, 'name_key': 'sample_rate_8k'},
    '11025': {'rate': 11025, 'name_key': 'sample_rate_11k'},
    '16000': {'rate': 16000, 'name_key': 'sample_rate_16k'},
    '22050': {'rate': 22050, 'name_key': 'sample_rate_22k'},
    '32000': {'rate': 32000, 'name_key': 'sample_rate_32k'},
    '44100': {'rate': 44100, 'name_key': 'sample_rate_44k', 'default': True},
    '48000': {'rate': 48000, 'name_key': 'sample_rate_48k'},
    '88200': {'rate': 88200, 'name_key': 'sample_rate_88k'},
    '96000': {'rate': 96000, 'name_key': 'sample_rate_96k'},
    '176400': {'rate': 176400, 'name_key': 'sample_rate_176k'},
    '192000': {'rate': 192000, 'name_key': 'sample_rate_192k'},
}

# Для channels тоже порядковые номера
CHANNELS = {
    '1': {'channels': 1, 'name_key': 'channels_mono'},
    '2': {'channels': 2, 'name_key': 'channels_stereo', 'default': True},
    '4': {'channels': 4, 'name_key': 'channels_quad'},
    '6': {'channels': 6, 'name_key': 'channels_51'},
    '8': {'channels': 8, 'name_key': 'channels_71'},
}
...
TRANSLATIONS = {
    'en': {
        ...
        'select_format': 'Select output format (one letter)',
    ...
    'ru': {
        ...
        'select_format': 'Выберите выходной формат (одна буква)',
...
class Settings:
    ...
    def __init__(self):
        ...
        self.output_format = 'm'        # default format key (one letter)
...
class AudioConverter:
    ...
    def _convert_single_file(self, input_path: str, output_path: str, target_format: str,
        ...
        try:
            ...
            if 'quality' in settings:
                if target_format == 'm':  # mp3
                    cmd.extend(['-q:a', str(settings['quality'])])
                elif target_format == 'g':  # ogg
                    cmd.extend(['-q:a', str(settings['quality'])])
    ...
    def _run_conversion(self, files: List[str], target_format: str,
        ...
        for i, input_path in enumerate(files, 1):
            ...
            target_ext = AUDIO_FORMATS[target_format]['ext']
    ...
    def run_conversion_workflow(self, folder=None, files=None):
        ...
        # Step 3: Select output format (now with single-letter keys)
        ...
        for letter, display_name in format_order:
            fmt = AUDIO_FORMATS[letter]
            desc = self.locale.t(fmt['desc_key'])
            default_marker = " (default)" if letter == self.settings.output_format else ""
            if self.console:
                self.console.print(f"  [bold yellow][{letter.upper()}][/bold yellow] {display_name} - {desc}{default_marker}")
            else:
                print(f"  [{letter.upper()}] {display_name} - {desc}{default_marker}")
        print(f"  0 - {self.locale.t('cancel')}")

        valid_choices = [letter for letter, _ in format_order] + ['0']
        choice = self._prompt_choice(self.locale.t('enter_choice'), valid_choices)
        if choice == "0":
            return
        ...
        conv_settings = {}
        fmt_info = AUDIO_FORMATS[target_format]
        is_lossless = fmt_info.get('lossless', False)

        if is_lossless:
            # Bit depth (sample format)
            if 'sample_formats' in fmt_info:
                print(f"\n{self.locale.t('bit_depth')}:")
                sample_keys = list(fmt_info['sample_formats'].keys())
                for sk in sample_keys:
                    sf = fmt_info['sample_formats'][sk]
                    name = self.locale.t(sf['name_key'])
                    default = sf.get('default', False)
                    marker = " (default)" if default else ""
                    if self.console:
                        self.console.print(f"  [bold yellow][{sk}][/bold yellow] {name}{marker}")
                    else:
                        print(f"  [{sk}] {name}{marker}")
                print(f"  0 - {self.locale.t('original')}")
                choice = self._prompt_choice(self.locale.t('enter_choice'), sample_keys + ['0'])
                if choice != "0":
                    conv_settings['sample_fmt'] = choice
            # Compression level (FLAC)
            if 'compression_levels' in fmt_info:
                print(f"\n{self.locale.t('compression')}:")
                comp_keys = list(fmt_info['compression_levels'].keys())
                for ck in comp_keys:
                    cl = fmt_info['compression_levels'][ck]
                    name = self.locale.t(cl['name_key'])
                    default = cl.get('default', False)
                    marker = " (default)" if default else ""
                    if self.console:
                        self.console.print(f"  [bold yellow][{ck}][/bold yellow] {name} (level {cl['level']}){marker}")
                    else:
                        print(f"  [{ck}] {name} (level {cl['level']}){marker}")
                print(f"  0 - {self.locale.t('default')}")
                choice = self._prompt_choice(self.locale.t('enter_choice'), comp_keys + ['0'])
                if choice != "0":
                    conv_settings['compression_level'] = fmt_info['compression_levels'][choice]['level']
        else:
            # Bitrate
            if 'bitrates' in fmt_info:
                print(f"\n{self.locale.t('bitrate')}:")
                bitrate_keys = list(fmt_info['bitrates'].keys())
                for bk in bitrate_keys:
                    br = fmt_info['bitrates'][bk]
                    name = self.locale.t(br['name_key'])
                    default = br.get('default', False)
                    marker = " (default)" if default else ""
                    if self.console:
                        self.console.print(f"  [bold yellow][{bk}][/bold yellow] {br['bitrate']} ({name}){marker}")
                    else:
                        print(f"  [{bk}] {br['bitrate']} ({name}){marker}")
                print(f"  0 - {self.locale.t('default')}")
                choice = self._prompt_choice(self.locale.t('enter_choice'), bitrate_keys + ['0'])
                if choice != "0":
                    conv_settings['bitrate'] = fmt_info['bitrates'][choice]['bitrate']
            # Quality (MP3, OGG)
            if 'qualities' in fmt_info:
                print(f"\n{self.locale.t('quality')}:")
                quality_keys = list(fmt_info['qualities'].keys())
                for qk in quality_keys:
                    qv = fmt_info['qualities'][qk]
                    name = self.locale.t(qv['name_key'])
                    default = qv.get('default', False)
                    marker = " (default)" if default else ""
                    if self.console:
                        self.console.print(f"  [bold yellow][{qk}][/bold yellow] {name} (level {qv['quality']}){marker}")
                    else:
                        print(f"  [{qk}] {name} (level {qv['quality']}){marker}")
                print(f"  0 - {self.locale.t('default')}")
                choice = self._prompt_choice(self.locale.t('enter_choice'), quality_keys + ['0'])
                if choice != "0":
                    conv_settings['quality'] = fmt_info['qualities'][choice]['quality']

        # Sample rate – теперь используем порядковые номера
        print(f"\n{self.locale.t('setting_sample_rate')}:")
        sr_keys = list(SAMPLE_RATES.keys())
        for idx, key in enumerate(sr_keys, start=1):
            sr = SAMPLE_RATES[key]
            name = self.locale.t(sr['name_key'])
            default = sr.get('default', False)
            marker = " (default)" if default else ""
            if self.console:
                self.console.print(f"  [bold yellow][{idx}][/bold yellow] {sr['rate']} Hz - {name}{marker}")
            else:
                print(f"  [{idx}] {sr['rate']} Hz - {name}{marker}")
        print(f"  0 - {self.locale.t('original')}")
        choice = self._prompt_choice(self.locale.t('enter_choice'), [str(i) for i in range(1, len(sr_keys)+1)] + ['0'])
        if choice != "0":
            conv_settings['sample_rate'] = SAMPLE_RATES[sr_keys[int(choice)-1]]['rate']

        # Channels – тоже порядковые номера
        print(f"\n{self.locale.t('setting_channels')}:")
        ch_keys = list(CHANNELS.keys())
        for idx, key in enumerate(ch_keys, start=1):
            ch = CHANNELS[key]
            name = self.locale.t(ch['name_key'])
            default = ch.get('default', False)
            marker = " (default)" if default else ""
            if self.console:
                self.console.print(f"  [bold yellow][{idx}][/bold yellow] {ch['channels']} channels - {name}{marker}")
            else:
                print(f"  [{idx}] {ch['channels']} channels - {name}{marker}")
        print(f"  0 - {self.locale.t('original')}")
        choice = self._prompt_choice(self.locale.t('enter_choice'), [str(i) for i in range(1, len(ch_keys)+1)] + ['0'])
        if choice != "0":
            conv_settings['channels'] = CHANNELS[ch_keys[int(choice)-1]]['channels']

        # Step 5: Output folder
        self._print(f"\n[bold]{self.locale.t('output_folder')}[/bold]")
        display_name = AUDIO_FORMATS[target_format]['display']
        default_output = os.path.join(folder, f"converted_{display_name}")
    ...
    def settings_menu(self):
        ...
        while True:
            ...
            if choice == "0":
                ...
                for letter, display_name in format_order:
                    if self.console:
                        self.console.print(f"  [bold yellow][{letter.upper()}][/bold yellow] {display_name}")
                    else:
                        print(f"  [{letter.upper()}] {display_name}")
                fmt_choice = self._prompt_choice(self.locale.t('enter_choice'), 
                                                 [letter for letter, _ in format_order])
                self.settings.output_format = fmt_choice
                self.settings.save()
            elif choice == "8":
    ...
    def main_menu(self):
        ...
        while True:
            ...
            if self.console:
                ...
                print("4. " + self.locale.t('menu_settings'))
                print("5. " + self.locale.t('menu_ffmpeg'))
